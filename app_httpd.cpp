...
static esp_err_t stream_handler(httpd_req_t *req) {
  ...
  while (true) {
    ...
    transmission_sum += (fr_end - send_start) / 1000;
    fps_sum += 1000/frame_time;
    frames += 1;
#if ARDUHAL_LOG_LEVEL >= ARDUHAL_LOG_LEVEL_INFO
  ...
  printf(
    "Stream ended. Avg. frame rate: %lld FPS    Agv. transmission latency: %lld ms\n",
    (long long) (fps_sum/frames),
    (long long) (transmission_sum/frames)
  );
